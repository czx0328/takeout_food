<template>
	<div>
		...
		<el-input v-model="list.name" clearable placeholder="请输入栏目名称" style="width:200px;display:inline-block"></el-input>
    ...
    <el-table-column  prop="icon" label="icon">
		...
		<el-avatar :size="50" :src="scope.row.icon" alt="图片找不到" style="width:75px;height:60px">
		</el-avatar></template>
		</el-table-column>
	<el-table-column
      fixed="right"
      ...
      <template slot-scope="scope">
        ...
        <el-button @click="delHandler(scope.row.id)" type="text" size="small">删除栏目</el-button>
      </template>
    </el-table-column>
  </el-table>
  <!-- 表格结束 -->
