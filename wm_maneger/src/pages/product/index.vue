<template>
	<div>
		...
		<el-input v-model="list.name" clearable placeholder="请输入产品名称" style="width:200px;display:inline-block"></el-input>
		<el-button type="primary" size="small" @click="searchHandle">查询</el-button>
  	<el-table :data="products" border style="width: 100%">
		<el-table-column prop="id" label="ID" width="180"></el-table-column>
		<el-table-column prop="name" label="产品名称"></el-table-column>
		<el-table-column prop="description" label="描述"></el-table-column>
		<el-table-column  width="50px" prop="jsps" label="即时配送"></el-table-column>
		<el-table-column  width="50px" prop="price" label="价格"></el-table-column>
		<el-table-column prop="photo" label="照片" >
			<template slot-scope="scope">
				<img :src="scope.row.photo" alt="图片找不到" style="width:130px;height:60px">
			</template>
		</el-table-column>
		<el-table-column
		fixed="right"
  ...
  <el-form :model="form">
	...
	<el-form-item label="产品描述">
      <el-input v-model="form.description" clearable placeholder="请输入产品描述"></el-input>
    </el-form-item>
   ...
   <el-form-item label="产品照片地址">
      <el-input v-model="form.photo" clearable placeholder="请输入产品照片地址"></el-input>
    </el-form-item>
  </el-form>
