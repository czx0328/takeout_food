<template>
	<div>
		<el-button type="primary" size="small" @click="toAddHandler">添加外卖员</el-button>
		<el-input v-model="list.username" clearable placeholder="请输入外卖员姓名" style="width:200px;display:inline-block"></el-input>
	<el-button type="primary" size="small" @click="searchHandle">查询</el-button>
	
  	<el-table :data="waiters" border style="width: 100%">
    <el-table-column prop="id" label="ID" width="180"></el-table-column>
    <el-table-column prop="username" label="外卖员姓名"></el-table-column>
  ...
  show-text>
	...
	<el-table-column
      ...
      <template slot-scope="scope">
        ...
        <el-button @click="delHandler(scope.row.id)" type="text" size="small">删除该外卖员</el-button>
      </template>
    </el-table-column>
  </el-table>
  <!-- 表格结束 -->
  ...
  <el-form :model="form">
    <el-form-item label="外卖员姓名">
      <el-input v-model="form.username" clearable placeholder="请输入外卖员姓名"></el-input>
    </el-form-item>
	<el-form-item label="工资">
      <el-input v-model="form.money" clearable placeholder="请输入工资"></el-input>
    </el-form-item>
	<el-form-item label="手机号">
      <el-input  v-model="form.telephone" clearable placeholder="请输入外卖员手机号"></el-input>
    </el-form-item>
